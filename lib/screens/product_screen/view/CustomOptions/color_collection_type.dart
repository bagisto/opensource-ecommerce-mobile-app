...
import 'package:bagisto_app_demo/helper/extension.dart';
...
class ColorCollectionType extends StatefulWidget {
  ...
  dynamic seletedId;
  List? optionArray;
  ColorCollectionType({Key? key, this.variation, this.callback,this.options,this.seletedId, this.optionArray}) : super(key: key);
            ...
            return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: ((item.swatchValue ?? "").isNotEmpty && item.swatchValue !=null) ? HexColor.fromHex(item.swatchValue??''):Colors.transparent,
