...
import '../../base_model/graphql_base_error_model.dart';
import '../cart_model/cart_data_model.dart';
import '../homepage_model/new_product_data.dart';
...
@JsonSerializable()
class Product extends GraphQlBaseErrorModel{
  String ?  shareURL;
  ...
  ConfigurableData? configutableData;
  String? sku;
  String? parentId;
 ...
 dynamic percentageRating;
  ...
  Product({this.additionalData,this.id, this.priceHtml,this.type, this.isInWishlist,this.attributeFamilyId, this.sku, this.parentId, this.productFlats, this.variants,
    this.attributeFamily, this.attributeValues, this.superAttributes, this.categories, this.inventories, this.images, this.reviews,
    this.groupedProducts, this.downloadableSamples, this.downloadableLinks, this.bundleOptions, this.customerGroupPrices, this.booking,this.cart,this.shareURL});
...
var weight;
  ...
  ProductFlats({this.id, this.sku,this.minPrice,this.maxPrice, this.productNumber, this.name, this.description, this.shortDescription, this.urlKey, this.isNew, this.featured, this.status, this.visibleIndividually,this.specialPrice, this.specialPriceFrom, this.specialPriceTo, this.weight,
    this.color, this.colorLabel, this.size, this.sizeLabel, this.locale, this.channel, this.productId,   this.metaTitle, this.metaKeywords, this.metaDescription, this.width, this.height,  this.createdAt, this.updatedAt});
...
class DownloadableProduct {
  ...
  DownloadableProduct({this.id, this.title, this.price, this.url, this.file, this.fileName, this.type, this.sampleUrl, this.sampleFile, this.sampleFileName, this.sampleType, this.sortOrder, this.productId, this.downloads, this.translations});
