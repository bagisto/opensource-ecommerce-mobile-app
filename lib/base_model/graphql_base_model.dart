...
@JsonSerializable()
class GraphQlBaseModel extends HiveObject{
  String? success;
  bool? status;///this variable use to check whether API response is true of false?
  String? message;
  int? cartCount;///ths variable is use to save cart count
  dynamic error;
